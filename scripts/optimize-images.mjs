...
//
// Los fuente viven en assets-src/ (no en public/): public/ se sirve entero en
// producción y el PNG de 540K era descargable sin que ninguna vista lo usara.
//
//   assets-src/logohumap-sinfondo.png (540K)  ->  public/favicon.png (64x64)
//                                                 public/apple-touch-icon.png (180x180)
//                                                 public/logo.png (512px, para JSON-LD Organization)
//   assets-src/logohumap-white.png            ->  public/og-image.png (1200x630, formato social)
...
await sharp(src("logohumap-sinfondo.png"))
...
await sharp(src("logohumap-white.png"))
...
const W = 1200;
const H = 630;
const logo = await sharp(src("logohumap-white.png")).resize(560, 560, { fit: "inside" }).toBuffer();
await sharp({
